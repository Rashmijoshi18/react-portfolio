...
{/* // // 										style={{ aspectRatio: "auto" }} */}
							...
							<div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#00f0ff]/10 to-[#ff007f]/10 p-1">
								<div className="bg-[#0f0f17] rounded-3xl p-3">
									<img
										src={me}
										alt="Rashmi Joshi - Web Developer"
										className="w-56 h-72 sm:w-64 sm:h-80 lg:w-72 lg:h-96 object-cover rounded-2xl transition-all duration-500 hover:scale-105 active:scale-105 shadow-2xl"
									/>
								</div>
							</div>
					...
					<div className="lg:col-span-3 space-y-6">
						{/* Who am I */}
						<div className="group">
							<div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-white/10 hover:border-[#00f0ff]/30 active:border-[#00f0ff]/30 transition-all duration-300 hover:transform hover:scale-[1.02] active:transform active:scale-[1.02]">
								<div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
									<div className="p-2 sm:p-3 bg-[#00f0ff]/10 rounded-full">
										<UserIcon className="w-5 h-5 sm:w-6 sm:h-6 text-[#00f0ff]" />
									</div>
				...
				<div className="mt-16 sm:mt-20 text-center">
					...
					<div className="flex flex-wrap justify-center gap-3 sm:gap-4 max-w-2xl mx-auto">
						{["React", "JavaScript", "HTML/CSS", "Tailwind CSS", "Vite", "Git","bootstrap"].map((tech) => (
							<span
								key={tech}
								className="px-4 py-2 sm:px-6 sm:py-3 bg-white/10 backdrop-blur-sm rounded-full text-xs sm:text-sm font-medium border border-white/20 hover:border-[#00f0ff]/50 hover:bg-[#00f0ff]/10 active:border-[#00f0ff]/50 active:bg-[#00f0ff]/10 transition-all duration-300 hover:transform hover:scale-105 active:transform active:scale-105 cursor-pointer"
							>
								{tech}
							</span>
						))}
				...
				<div className="mt-12 sm:mt-16 text-center">
					...
					<a
						href="#contact"
						className="inline-flex items-center gap-2 bg-gradient-to-r from-[#00f0ff] to-[#44d2e1] text-black font-bold px-6 py-3 sm:px-8 sm:py-4 rounded-full hover:scale-105 active:scale-105 hover:shadow-lg hover:shadow-cyan-500/30 active:shadow-lg active:shadow-cyan-500/30 transition-all duration-300 text-sm sm:text-base"
					>
						Get In Touch
						<ArrowRightIcon className="w-4 h-4 sm:w-5 sm:h-5" />
					</a>
