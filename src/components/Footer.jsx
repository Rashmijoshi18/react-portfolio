...
const Footer = () => {
	...
	const socialLinks = [
		{
			name: "LinkedIn",
			url: "https://www.linkedin.com/in/rashmi-joshi-148850320/",
			icon: (
			...
			bgHover: "group-hover:shadow-[#0077b5]/20",
		},
		{
			name: "GitHub",
			url: "https://github.com/Rashmijoshi18",
			icon: (
				<svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
			...
			bgHover: "group-hover:shadow-gray-800/20",
		},
		{
			name: "Email",
			url: "mailto:rashmijoshi3699@gmail.com",
			icon: (
				<svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
			...
			bgHover: "group-hover:shadow-[#ea4335]/20",
		},
	];
				...
				<div className="max-w-6xl mx-auto">
						...
						<div className="flex items-center gap-4">
							{socialLinks.map((social, index) => (
								<a
									...
									className={`group relative flex items-center justify-center w-12 h-12 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 transition-all duration-300 hover:scale-110 hover:border-white/40 ${social.color} animate-fade-in-up`}
					...
					<div className="absolute top-4 right-4">
						<button
							...
							className="group flex items-center justify-center w-10 h-10 bg-[#00f0ff]/20 hover:bg-[#00f0ff]/40 backdrop-blur-sm rounded-full border border-[#00f0ff]/30 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-[#00f0ff]/20"
							aria-label="Back to top"
						>
							<svg
								className="w-4 h-4 text-[#00f0ff] group-hover:text-white transition-colors duration-300"
								fill="currentColor"
								viewBox="0 0 20 20"
							>
								<path
